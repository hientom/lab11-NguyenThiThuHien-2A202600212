...
def content_filter(response: str) -> dict:
    ...
    PII_PATTERNS = {
        ...
        "National ID (CCCD/CMND)": r"\b\d{9}\b|\b\d{12}\b",
...
class OutputGuardrailPlugin(base_plugin.BasePlugin):
    ...
    async def after_model_callback(
        ...
        *,
        ...
        response_texr = filter_result["redacted"]
        ...
        #    - If unsafe: replace llm_response.content with a safe message
            block_message = f"[Output Blocked] Cau tra loi nay da bi chan do vi pham quy tac an toan cua VinBank \nLy do: {judge_result['verdict']}"
